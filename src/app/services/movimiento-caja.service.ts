...
export class MovimientoCajaService {
  ...
  putMovimientoConceptoCuenta(data: any, id: string) {
    return this.http.put<any>(
      this.url + "movimiento/concepto/cuenta/" + id,
      data
    );
  }
  ...
  getMovimientoConceptoTipoComprobante(id: number) {
    return this.http.get<any>(
      this.url + "movimiento/concepto/comprobante?id=" + id
    );
  }

  setMovimientoConceptoTipoComprobante(data: any) {
    return this.http.post<any>(
      this.url + "movimiento/concepto/comprobante",
      data
    );
  }
  ...
  putMovimientoConceptoTipoComprobante(data: any, id: string) {
    return this.http.put<any>(
      this.url + "movimiento/concepto/comprobante/" + id,
      data
    );
  }
  ...
  putMovimientoConceptoMoneda(data: any, id: string) {
    return this.http.put<any>(
      this.url + "movimiento/concepto/moneda/" + id,
      data
    );
  }
  ...
  geRegistroMovimientoBydate(fechaDesde: string, fechaHasta: string) {
    return this.http.get<any>(
      this.url +
        "movimiento/registro/by/date?fecha_desde=" +
        fechaDesde +
        "&fecha_hasta= " +
        fechaHasta
    );
  ...
  getMovimientoConceptoCuentasv2() {
    return this.http.get<any[]>(this.url + "v2/movimiento/concepto/cuentas");
  }

  geRegistroMovimientoBydatev2(fechaDesde: string, fechaHasta: string) {
    return this.http.get<any>(
      this.url +
        "v2/movimiento/registro/by/date?fecha_desde=" +
        fechaDesde +
        "&fecha_hasta= " +
        fechaHasta
    );
  ...
  setMovimientoCajav2(data: any) {
    return this.http.post<any>(this.url + "v2/movimiento/caja", data);
  }

  putMovimientoCajav2(data: any, id: string) {
    return this.http.put<any>(this.url + "v2/movimiento/caja/" + id, data);
  }
}
