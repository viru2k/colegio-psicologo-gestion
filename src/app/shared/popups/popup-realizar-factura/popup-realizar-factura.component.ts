...
@Component({
  selector: 'app-popup-realizar-factura',
  templateUrl: './popup-realizar-factura.component.html',
  styleUrls: ['./popup-realizar-factura.component.scss']
})
export class PopupRealizarFacturaComponent implements OnInit {
