...
const routes: Routes = [
  ...
  { path: "404", component: NotFoundComponent },
  {
    ...
    children: [
      ...
      {
        path: "liquidacion/expediente/listado",
        component: LiquidarExpedienteComponent,
      },
      {
        path: "liquidacion/confeccionar",
      ...
      {
        path: "configuracion/caja/cuenta",
        component: MovimientoCuentaComponent,
      },
      {
        path: "configuracion/caja/concepto/cuenta",
        component: MovimientoConceptoCuentaComponent,
      },
      {
        path: "configuracion/caja/comprobante",
        component: MovimientoTipoComprobanteComponent,
      },
      {
        path: "configuracion/caja/moneda",
        component: MovimientoTipoMonedaComponent,
      },
      ...
      { path: "multimedia", component: VideoAdministrarComponent },
      ...
      {
        path: "factura/electronica/otras/acciones",
        component: OtrasAccionesComponent,
      },
